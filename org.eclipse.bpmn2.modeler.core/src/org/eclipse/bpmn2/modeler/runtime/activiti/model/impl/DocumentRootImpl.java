...
import org.eclipse.bpmn2.modeler.runtime.activiti.model.HistoryType;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getExecutionListener <em>Execution Listener</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getField <em>Field</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getFormProperty <em>Form Property</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getIn <em>In</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getOut <em>Out</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getTaskListener <em>Task Listener</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getAssignee <em>Assignee</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getCandidateGroups <em>Candidate Groups</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getCandidateUsers <em>Candidate Users</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getDelegateExpression <em>Delegate Expression</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getDueDate <em>Due Date</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getElementVariable <em>Element Variable</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getFormHandlerClass <em>Form Handler Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getFormKey <em>Form Key</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getHistory <em>History</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getInitiator <em>Initiator</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getResultVariable <em>Result Variable</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#isAsync <em>Async</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getActExpression <em>Act Expression</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getResultVariableName <em>Result Variable Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.activiti.model.impl.DocumentRootImpl#getFailedJobRetryTimeCycle <em>Failed Job Retry Time Cycle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
