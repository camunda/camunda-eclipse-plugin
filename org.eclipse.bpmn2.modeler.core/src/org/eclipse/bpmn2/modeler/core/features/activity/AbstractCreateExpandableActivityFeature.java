...
public abstract class AbstractCreateExpandableActivityFeature<T extends Activity> extends
		AbstractCreateFlowElementFeature<T> {

	public AbstractCreateExpandableActivityFeature(IFeatureProvider fp, String name,
			String description) {
