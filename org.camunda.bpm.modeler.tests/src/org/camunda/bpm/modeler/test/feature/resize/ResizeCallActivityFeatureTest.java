 ...
 */
public class ResizeCallActivityFeatureTest extends AbstractFeatureTest {
	
	@Test
	@DiagramResource("org/camunda/bpm/modeler/test/feature/resize/ResizeCallActivityFeatureTest.testBase.bpmn")
