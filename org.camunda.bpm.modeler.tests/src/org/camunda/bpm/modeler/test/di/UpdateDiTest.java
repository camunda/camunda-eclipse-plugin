package org.camunda.bpm.modeler.test.di;

import static org.camunda.bpm.modeler.test.util.operations.AddEventDefinitionOperation.addEventDefinition;
...
public class UpdateDiTest extends AbstractFeatureTest {
	...
	@Test
	@DiagramResource("org/camunda/bpm/modeler/test/di/UpdateDiTest.testUpdateEventDiInSubprocess.bpmn")
