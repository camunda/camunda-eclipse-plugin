...
public class SequenceFlowTest extends AbstractFeatureTest {
	...
	@Test
	@DiagramResource("org/camunda/bpm/modeler/test/layout/FlowReconnectTest.testManualReconnectSequenceFlow.bpmn")
	...
	@Test
	@DiagramResource("org/camunda/bpm/modeler/test/layout/SequenceFlowTest.testBaseHorizontal.bpmn")
	public void testMoveLayoutedHorizontalNoAdjust() {
		testMoveNonBreaking(point(10, 0));
	}
	
	@Test
	@DiagramResource("org/camunda/bpm/modeler/test/layout/SequenceFlowTest.testBaseVertical.bpmn")
