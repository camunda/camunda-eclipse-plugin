 ...
 * <ul>
 *   <li>{@link org.camunda.bpm.modeler.runtime.engine.model.impl.ConstraintTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.camunda.bpm.modeler.runtime.engine.model.impl.ConstraintTypeImpl#getConfig <em>Config</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintTypeImpl extends EObjectImpl implements ConstraintType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CONSTRAINT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONSTRAINT_TYPE__NAME, oldName, name));
	}
	...
	public void setConfig(String newConfig) {
		...
		config = newConfig;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONSTRAINT_TYPE__CONFIG, oldConfig, config));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.CONSTRAINT_TYPE__NAME:
				return getName();
			case ModelPackage.CONSTRAINT_TYPE__CONFIG:
				return getConfig();
		}
