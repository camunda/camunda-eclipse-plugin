...
public class ModelImport {
	...
	public ModelImport(IDiagramEditor diagramEditor, Bpmn2Resource bpmnResource, Resource diagramResource, boolean withScrollShape) {
		this(diagramEditor, bpmnResource, diagramResource);
		this.withScrollShape = withScrollShape;
	}
	
	public ModelImport(IDiagramEditor diagramEditor, Bpmn2Resource bpmnResource, Resource diagramResource) {
