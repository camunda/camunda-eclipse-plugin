...
public class Bpmn2RefreshBehavior extends DefaultRefreshBehavior {
	...
	public Bpmn2RefreshBehavior(Bpmn2Editor diagramEditor) {
		super(diagramEditor);
	}
	...
	private void importDiagram(Bpmn2Resource bpmnResource, Resource diagramResource) {
		...
		ModelImportCommand command = new ModelImportCommand(editingDomain, diagramEditor, bpmnResource, diagramResource);
	...
	private void refreshPalette() {
		GFPaletteRoot paletteRoot = (GFPaletteRoot) getDiagramEditor().getPaletteBehavior().getPaletteRoot();
