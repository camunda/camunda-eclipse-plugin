...
/**
 * A nearly exact copy of {@link AbstractColumnLayout}. 
 ...
 * 
 * Actual fix is done in two code lines tagged with <code>MAGIC NUMBER</code>.
 * 
 * @author nico.rehwaldt
 */
public abstract class AbstractColumnLayout2 extends Layout {
	...
	protected void layout(Composite composite, boolean flushCache) {
		...
		int width = Math.max(0, area.width - trim); // MAGIC NUMBER !!11
