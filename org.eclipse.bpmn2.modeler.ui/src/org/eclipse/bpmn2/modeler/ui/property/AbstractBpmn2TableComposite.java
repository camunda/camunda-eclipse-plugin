...
//			detailComposite = toolkit.createComposite(detailSection,SWT.NONE);
			detailComposite = new DefaultPropertiesComposite(detailSection, SWT.NONE){
				@Override
			...
			tableSection.addExpansionListener(new IExpansionListener() {
				...
				public void expansionStateChanged(ExpansionEvent e) {
					if (!e.getState()) {
						detailSection.setVisible(false);
						AbstractBpmn2TableComposite.this.layout(true);
						AbstractBpmn2TableComposite.this.getParent().layout(true);
					}
				}
