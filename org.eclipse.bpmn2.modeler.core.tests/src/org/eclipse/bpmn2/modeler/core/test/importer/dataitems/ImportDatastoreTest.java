...
public class ImportDatastoreTest extends AbstractImportBpmn2ModelTest {
	...
	public void testImportDatastore() {
		...
		TransactionalEditingDomain domain = createEditingDomain("org/eclipse/bpmn2/modeler/core/test/importer/dataitems/ImportDatastoreTest.testImportDatastore.bpmn");
